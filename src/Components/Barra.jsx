    ...
    <Navbar className='barra'>
      <Container >
        ...
        <Nav style={{ display: 'flex', justifyContent: 'flex-end' }}>
          ...
          <NavLink style={{ border: '1px solid', borderRadius: '14px', marginLeft: '1em', marginRight: '1.5em' }} className={({ isActive }) => (isActive ? "viewActiva" : "view")} to="/Registro">Registrarse</NavLink>
